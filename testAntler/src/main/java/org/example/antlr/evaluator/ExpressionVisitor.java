...
import com.example.antlr.ExpressionLanguageBaseVisitor;
...
public class ExpressionVisitor extends ExpressionLanguageBaseVisitor<ExpressionNode>
        implements com.example.antlr.ExpressionLanguageVisitor<ExpressionNode> {
    Logger logger = Logger.getLogger(ExpressionVisitor.class.getName());

    @Override
    public ExpressionNode visitExpression(ExpressionLanguageParser.ExpressionContext ctx) {
